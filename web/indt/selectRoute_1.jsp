...
<sql:query 
        sql="SELECT route.route,route.timing from route where route.id = ? " 
        var="MOREVE"         
   ...
   <%-- <sql:query 
    ...
    <body style="background:#B3B366">          
        <form action="../customerList.jsp" method="get"><center>            
            <c:forEach var="column" items="${MOREVE.rows}">               
                <c:set scope="session" var="rtname" value="${column.route}"/>
            ...
            <table cellpadding="3" width="50%">    
                <tr>
                    <td>
                        <font style="font-size:16px;color:#ffffff;font-weight:bold">${state}&nbsp;&nbsp;${rtname}</font>
                    </td>                    
                    <td>
            ...
            <table width="50%" cellpadding="7%">   
              ...
              <tr class="list-row-odd"> 
                    ...
                    <td style="text-align: left;">
                            ...
                            <input readonly value="<fn:formatDate pattern="dd.MM.yyyy" value="${utlBen.indentDate}" type="date"/>" type="text" size="10" name="idate"> 
            ...
            <%--
                <tr style="font-size:16px;background-color: #000000;color: #ffffff">
                    ...
                    <th style="text-align: left">I&nbsp;N&nbsp;D&nbsp;E&nbsp;N&nbsp;T</th>
                </tr>                 
                ...
                --%>                
                <input id="rt" name="rt" type="hidden" value="${rtNumber}">
<%--
                <tr class="list-row-odd">
                    <td style="text-align: right;">
                        Milk Sales Route :                                         
                ...
                <tr class="list-row-even"> 
                    ...
                    <td style="text-align: left;">
                        <input value="<fn:formatDate pattern="dd.MM.yyyy" value="${utlBen.indentDate}" type="date"/>" type="text" size="10" name="idate"> 
                    </td>                       
                </tr>  
                --%>
                <input type="hidden" name="moreve" id="moreve" value="M">
<%--
                <tr class="list-row-odd">
                    <td style="text-align: right;">
