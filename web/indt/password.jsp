...
<html>
    ...
    <f:view>    
        ...
        <h:form><center>
            <input type="hidden" name="blnEG" value="true">
            <input type="hidden" name="gatePassList" value="false">         
            <input type="hidden" name="blnShow" value="false">
            <input type="hidden" name="blnCstData" value="false"> 
            <table>
                <tr>
                    <td>
                        <h:outputText style="color:#F9F900" value="Enter Magicword : " />
                    </td>
                    <td>
                ...
                <tr style="text-align:center">
                    <td></td>
                    <td>
                        <h:commandButton action="#{password.chkEditGatepass}" 
