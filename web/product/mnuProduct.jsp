                        ...
                        <tr valign="top">
                            <td><p class="toc level1"><a href="docinfo.html">Document Information</a></p>
                             ...
                             <%--   <p class="toc level2"><a href="bnayl.html">4.&nbsp;&nbsp;Indent Sheet</a></p>--%>
                                ...
                                <p class="selehead">7.&nbsp;&nbsp;Product</p>
                                <p class="toc level3">
                                    <h:commandLink  style="color:#3E6B8A; font-family:Monaco,'Courier New','Courier';font-size: 12px" 
                                        target="mainframe" action="#{product.createSetup}" 
                                        value="Add" />
                                </P>                                
                                <p class="toc level3">
                                    <h:commandLink  style="color:#3E6B8A; font-family:Monaco,'Courier New','Courier';font-size: 12px" 
                                                    target="mainframe" action="#{product.createUpdateSetup}" 
                                        value="Edit" />
                                </P>             <%--action="#{product.createUpdateSetup}" --%>                   
                                <p class="toc level3">
                                    <h:commandLink  style="color:#3E6B8A; font-family:Monaco,'Courier New','Courier';font-size: 12px" 
                                        target="mainframe" action="product_view" 
                                        value="View" />
                                </P>   
                                <p class="toc level3">
                                    <h:commandLink style="color:#3E6B8A; font-family:Monaco,'Courier New','Courier';font-size: 12px" 
                                         target="mainframe" action="LayoutORD" value="Layout Order"/>
                                </P>    
