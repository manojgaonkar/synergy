...
<html>
    ...
    <body style="background:#B3B366">
        <form method="get" action="../adjustment">       
            ...
            <table width="90%">
                <tr>
                    <td style="text-align: left;width: 3%;"> <H3>ADJUSTMENT ENTRIES</H3></td>
                    ...
                    <c:forEach begin="0" items="${customer.rows}" var="book" >                                            
                        ...
                        <tr style="background-color: #FF9DCE;color: #ffffff;font-size:16px;">
                            ...
                            <td style="text-align: left;width: 30%">                                                                                                   
                                <a accesskey="${book.firstname}" href="adjustment.jsp?blnrec=true&idate=<%=date%>&custtype=${book.custtype}&cacr=${book.cacr}&cc=${book.cacr}&custid=${book.id}&talid=${book.taluka}&routeid=${book.route}&rtname=${rt}&blnValue=true&blnCustList=false&firstname=${book.firstname}">${book.firstname}</a>
                            </td>     
                        </tr>       
                    </c:forEach>                                                                                  
                </table></center>                                            
            <%}else{%>              
                ...
                <table width="90%">
                    <tr>
                        <td style="font-size:14px; text-align: left;width: 5%;">     
                            <a href="adjustment.jsp?blnCustList=true&rt=<%=rt%>&custtype=<%=custtype%>">Customer List</a>
                        </td>                       
             ...
             <%--       <c:forEach begin="0" items="#{indent.rows}" var="book" varStatus="stat">
                        ...
                        <tr class="${(stat.index % 2) == 0 ? "list-row-even" : "list-row-odd"}">
                            ...
                            <td style="font-size:14px; text-align: center;width: 5%;">   
                                <input type="text" size="25" name="particulars"  value="${book.prodname}"> 
                            </td> 
                            <td style="font-size:14px; text-align: center;width: 5%;">   
                 ...
                 <%--   <%if(blnrec){%> --%>
                        ...
                        <tr class="list-row-even">
                            ...
                            <td style="font-size:14px; text-align: center;width: 5%;">   
                                <input  type="text" size="25" name="particulars"> 
                            </td> 
                            <td style="font-size:14px; text-align: center;width: 5%;">                               
                                <input type="submit" name="Add" value="Add">                            
                            </td>                            
