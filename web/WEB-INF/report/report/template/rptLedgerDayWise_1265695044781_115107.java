 ...
 *
 */
public class rptLedgerDayWise_1265695044781_115107 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 11 : 
            {
                value = (java.lang.Double)(new Double((((java.math.BigDecimal)field_netamount.getValue()).doubleValue() + ((java.math.BigDecimal)field_taxamt.getValue()).doubleValue()) - ((java.math.BigDecimal)field_subsidy.getValue()).doubleValue()));
                break;
            }
            case 12 : 
            {
                value = (java.lang.Double)(new Double(((java.math.BigDecimal)field_netamount.getValue()).doubleValue() - ((java.math.BigDecimal)field_subsidy.getValue()).doubleValue() ));
                break;
            }
            case 13 : 
            {
    ...
    public Object evaluateOld(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 11 : 
            {
                value = (java.lang.Double)(new Double((((java.math.BigDecimal)field_netamount.getOldValue()).doubleValue() + ((java.math.BigDecimal)field_taxamt.getOldValue()).doubleValue()) - ((java.math.BigDecimal)field_subsidy.getOldValue()).doubleValue()));
                break;
            }
            case 12 : 
            {
                value = (java.lang.Double)(new Double(((java.math.BigDecimal)field_netamount.getOldValue()).doubleValue() - ((java.math.BigDecimal)field_subsidy.getOldValue()).doubleValue() ));
                break;
            }
            case 13 : 
            {
