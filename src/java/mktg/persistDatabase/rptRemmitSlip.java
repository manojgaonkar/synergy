...
/**
 *      mktg.persistDatabase.rptRemmitSlip
 * @author xp
 */
public class rptRemmitSlip {
    ...
    public void dispReport(ActionEvent ae){
        ...
        InputStream is = null;
        String filename = "/WEB-INF/report/report/template/rptPaySlip.jasper";        
        try {
            ...
            params.put("m_route",new Integer(this.routeId.intValue()));
