...
import mktg.backingBean.editgatepass;
 ...
 * @version
 */
public class editgatepassSer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        id = (editgatepass) hs.getAttribute("editgatepass");
...
//        hs.setAttribute("editgatepass",null);    
        id.reInit();
        out.println("<a href='indt/editGatePass.jsp?blnEG=true&blnShow=false&blnCstData=false&idate="+utl.ToDate(idate)+"'> Back</a>"); 
        out.println("</body>");
        out.println("</html>");
        out.close();
    }
